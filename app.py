...
# ##  V- SEVERITY / DESCRIPTION / PRECAUTION
...
def get_bot_response():
    ...
    if "step" in session:
        if session["step"] == "Q_C":
            ...
            session.clear()
            if s == "q":
                "Thank you for using our web site Mr/Ms " + name
            else:
                session["step"] = "FS"
                session["name"] = name
                session["age"] = age
    ...
    if session['step'] == "BYE":
        ...
        if s.lower() == "yes":
            ...
            return "THANKS Mr/Ms " + name + " for using me for more information please contact <b> +919996665544</b>"
